...
- `SITE_ORIGIN`: the trusted HTTPS origin used in invitation links, without a
  path, query, or trailing content (for example `https://alsaadcom.com`).
...
unset. Run `pnpm run dev`. This opens the name/email/NDA preview gate.
